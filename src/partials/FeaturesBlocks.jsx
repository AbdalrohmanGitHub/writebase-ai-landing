      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">Start generating content in 3 <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-700 to-yellow-600">easy </span>steps</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-700 to-yellow-600">1. </span>Select a module</h4>
              <p className="text-gray-600 text-center">Choose from an array of AI tools to write social content, copy, articles & more.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  <rect className="fill-current text-blue-600" width="64" height="64" rx="32" />
                  <g strokeWidth="10" transform="translate(19.429 20.571)">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-700 to-yellow-600">2. </span>Fill in the details</h4>
              <p className="text-gray-600 text-center">Explain with as many details as possible to the AI what you want the content to be about.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  <rect className="fill-current text-blue-600" width="64" height="64" rx="32" />
                  <g strokeLinecap="square" strokeWidth="10">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1"><span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-700 to-yellow-600">3. </span>Generate AI content</h4>
              <p className="text-gray-600 text-center">Our AI understands your details and generates unique human-like content in seconds.</p>
            </div>
