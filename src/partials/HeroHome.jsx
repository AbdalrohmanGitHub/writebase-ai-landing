...
import HeroImage from '../images/jaeves-hero.png';
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Jaeves is the content generator that helps remove creative-block, and pushes your team to create amazing original content. It's time to give your content a refresh! </p>
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                ...
                <p><small><i>*Free for 3 days, then <u>$4/month</u>.</i></small></p>
                </div>
                { /*<div>
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              <div className="flex flex-col justify-center">
                <img className="mx-auto" src={HeroImage} width="768" height="432" alt="Hero" /> {/* Change Hero Image URL or Upload/Rename new Image */}
